...
redis_client = redis.Redis(
    host='usersdb-cache-kkfh9h.serverless.use1.cache.amazonaws.com:6379',
    port=6379,
    ssl=True,
...
db_write_config = {
    'host': 'usersdb.c6xkgac6c5dq.us-east-1.rds.amazonaws.com',
    'user': 'admin',
    'password': 'Cloud123',
    'database': 'dev'
}
...
db_read_config = {
    'host': 'reader-db-az1.c6xkgac6c5dq.us-east-1.rds.amazonaws.com',
    'user': 'admin',
    'password': 'Cloud123',
    'database': 'dev'
}
